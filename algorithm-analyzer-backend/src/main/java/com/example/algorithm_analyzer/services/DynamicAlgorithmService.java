// Plik: com/example/algorithm_analyzer/services/DynamicAlgorithmService.java
...
@Service
@Slf4j
public class DynamicAlgorithmService {
    ...
    @Autowired
    public DynamicAlgorithmService(List<Algorithm> builtInAlgorithms, CompilerConfiguration groovyCompilerConfig) {
