...
import ThemeToggle from "../../uiComponents/ThemeToggle"; // --- NOWY IMPORT ---
...
  isDarkMode, // Otrzymujesz ten prop
  toggleDarkMode // Oraz ten prop
}) {
...
        
        {/* --- POPRAWKA: Użyj propsów 'isDarkMode' i 'toggleDarkMode' --- */}
